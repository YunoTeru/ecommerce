...
require 'connection.php';
    ...
    function addOrders($prod_id, $user_id, $ord_quantity, $ord_date_ordered, $ord_date_released){
        $sql = "INSERT INTO ord_tbl(prod_id, cust_id, ord_quantity, ord_date_ordered, ord_date_released)
                VALUE ('$prod_id', '$user_id', '$ord_quantity', '$ord_date_ordered', '$ord_date_released')";
        $conn = connection();
