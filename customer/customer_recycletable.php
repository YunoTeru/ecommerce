...
<head>
    ...
    <title>Customer Recycle Table</title>
    <style type="text/css">
        .display-4{
...
<body>
    <div class="jumbotron  text-white">
        <h1 class="display-4">Customer Recycle Table</h1>
    </div>
    <div class="container-fuild">
        <h4 class="display4"><a href="customer_tbl.php" role="button" class="btn btn-info"><i class="fas fa-back"></i>Add Customer</a></h4>
